// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NextValues.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL
{
    ...
    public class NextValues : ValuesClause
    {
        public IEnumerable<Expression> ExpressionList { get; private set; }

        public NextValues(InsertStatement statement, IEnumerable<Expression> expressionList)
            : base(statement) {
            if (statement == null) {
