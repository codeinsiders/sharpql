// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IsLessThanOrEqualToPredicate.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL.Predicates
{
    ...
    public class IsLessThanOrEqualToPredicate : BinaryPredicateOperator
    {
        public IsLessThanOrEqualToPredicate(Expression leftOperand, Expression rightOperand)
