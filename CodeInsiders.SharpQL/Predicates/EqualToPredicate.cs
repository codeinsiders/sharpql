// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EqualToPredicate.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL.Predicates
{
    ...
    public class EqualToPredicate : BinaryPredicateOperator
    {
        public EqualToPredicate(Expression leftOperand, Expression rightOperand)
