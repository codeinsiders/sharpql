// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContainsPredicate.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL.Predicates
{
    ...
    public class ContainsPredicate : BinaryPredicateOperator
    {
        public ContainsPredicate(Expression leftOperand, Expression rightOperand)
