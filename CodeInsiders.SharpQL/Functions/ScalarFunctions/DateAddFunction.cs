// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DateAddFunction.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL.ScalarFunctions
{
    ...
    {
        public Expression Date { get; private set; }
        public DatePartType DatePart { get; private set; }
        public Expression Number { get; private set; }
        ...
        public override void Build(SqlFragment parent, TSqlVisitor visitor) {
            visitor.DateAddFunction(parent, this);
