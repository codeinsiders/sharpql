// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DivideArithmeticExpressionOperator.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL
{
    ...
    public class DivideArithmeticExpressionOperator : ArithmeticExpressionOperator
    {
