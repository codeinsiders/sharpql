// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Having.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL
{
    ...
    public class Having<T> : Clause<T>
        where T : IStatement
    {
        public Predicate SearchCondition { get; private set; }

        public Having(T statement, Predicate searchCondition)
            : base(statement) {
