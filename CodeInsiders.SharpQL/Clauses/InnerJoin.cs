// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InnerJoin.cs" company="CODE Insiders LTD">
// 
...
{
    public class InnerJoin<T> : JoinClause<T>
        where T : IStatement
    {
        public Predicate OnPredicate { get; private set; }
        public Table Table { get; private set; }

        public InnerJoin(T statement, Table table, Predicate onPredicate)
            : base(statement) {
            this.Table = table;
