// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RightOuterJoin.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL
{
    ...
    public class RightOuterJoin<T> : JoinClause<T>
        where T : IStatement
    {
        public Predicate OnPredicate { get; private set; }
        public Table Table { get; private set; }

        public RightOuterJoin(T statement, Table table, Predicate onPredicate)
            : base(statement) {
            if (table == null) {
