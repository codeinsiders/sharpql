// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SelectDistinct.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL
{
    ...
    public class SelectDistinct<T> : SelectClause<T>
        where T : IStatement
    {
        public IEnumerable<Expression> ColumnList { get; private set; }

        public SelectDistinct(T selectStatement, IEnumerable<Expression> columnList)
