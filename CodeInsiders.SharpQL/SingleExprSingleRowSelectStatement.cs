// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SingleExprSingleRowSelectStatement.cs" company="CODE Insiders LTD">
// 
...
namespace CodeInsiders.SharpQL
{
    ...
    public class SingleExprSingleRowSelectStatement : SelectStatement
    {
        ...
        public static implicit operator Expression(SingleExprSingleRowSelectStatement selectStm) {
            if (selectStm == null) {
                throw new ArgumentNullException("selectStm");
            }
            return new SingleExpSingleRowSelectStatementExpression(selectStm);
        }
    }
}